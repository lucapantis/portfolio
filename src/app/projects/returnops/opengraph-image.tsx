...
// Route-specific Open Graph card for the ReturnOps case study, built from the
// same palette and "LP" mark as the site-wide card. No external assets.
export const alt =
  "ReturnOps — Returns Management Platform. A full-stack case study by Luca Pantis.";
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div style={{ fontSize: 26, color: "#a1a1aa" }}>Case study</div>
        </div>
